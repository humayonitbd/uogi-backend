...
<p>
  This Privacy Policy describes how Uogi App ("we", "us", or "our") collects,
  uses, and shares your information when you use our mobile application ("App"),
  including our subscription and free plan access features.
</p>
...
<p>
  We collect information you provide when you edit your profile, including any
  changes to your name or email address.
</p>

<h2>Business Information</h2>
<p>
  When you add a business, we may collect the business name, details of payment
  type, image, business type, and location.
</p>

<h2>Service & Booking Information</h2>
<p>
  If you choose any service in any business, before booking you may read service
  details and select time slots. After completing payment, your booking is
  confirmed. We store booking-related information to manage and support your
  booking.
</p>

<h2>Subscription & Free Plan Information</h2>
<p>
  The App offers business packages, including paid subscriptions and a free plan.
  When you purchase, activate, or use a package, we may collect and process:
</p>
<ul>
  <li>the plan or package you selected</li>
  <li>subscription or free plan status (active, expired, canceled)</li>
  <li>access start and expiry dates</li>
  <li>
    eligibility and usage status for free plan access (for example, whether it
    has already been used)
  </li>
</ul>

<p>
  <strong>Free Plan (30 days):</strong> The free plan is maintained and enforced
  using our servers and APIs. This helps us determine eligibility (such as
  one-time activation per account) and provide the correct access duration.
</p>

<h2>Payment & Transaction Information</h2>
<p>
  Paid subscriptions are processed through the Apple App Store or Google Play and
  managed using a subscription management provider (such as RevenueCat). We do
  not store your full card details.
</p>
<p>We may receive limited transaction information such as:</p>
<ul>
  <li>product identifiers</li>
  <li>purchase or receipt references</li>
  <li>
    purchase status and subscription access status (to activate features and
    support restore)
  </li>
</ul>
...
<p>
  We may collect information about how you interact with the App, including your
  use of features and preferences.
</p>

<h2>How We Use Your Information</h2>
<p>We use your information to:</p>
<ul>
  <li>provide and improve the App's functionality and user experience</li>
  <li>activate and manage paid subscription access and free plan access</li>
  <li>
    verify eligibility and enforce package rules (such as one-time free plan
    access)
  </li>
  <li>communicate with you about your account and App-related updates</li>
  <li>enforce our Terms of Service and other legal agreements</li>
  <li>comply with legal obligations</li>
</ul>

<h2>Subscriptions, Auto-Renewal & Cancellation</h2>
<p>
  Paid subscriptions may renew automatically unless cancelled. You can cancel
  your subscription from your Apple App Store or Google Play account settings.
  The App does not directly cancel subscriptions on your behalf.
</p>
...
<p>
  The Uogi App is not intended for children under the age of 13. We do not
...
<p>
  ...
  contact us at helpdesk@uogi.com.
</p>

<footer>© 2025 Uogi App. All rights reserved.</footer>
